...
public partial class Workflow<TEvent>
{
    ...
    public Workflow<TEvent> Until(Func<TEvent, Task<bool>> predicate)
        => WorkflowImpl.UntilFromTaskPredicate(_workflow, predicate).ToWorkflow();
    ...
    public Workflow<TEvent> Until<TArg>(
        ...
        => WorkflowImpl.UntilFromTaskPredicate(_workflow, predicate.BindLast(arg)).ToWorkflow();
    ...
    public Workflow<TEvent> Until<TArg1, TArg2>(
        ...
        => WorkflowImpl.UntilFromTaskPredicate(_workflow, predicate.BindLast(arg1, arg2)).ToWorkflow();
    ...
    public Workflow<TEvent> Until<TArg1, TArg2, TArg3>(
        ...
        => WorkflowImpl.UntilFromTaskPredicate(_workflow, predicate.BindLast(arg1, arg2, arg3)).ToWorkflow();
}