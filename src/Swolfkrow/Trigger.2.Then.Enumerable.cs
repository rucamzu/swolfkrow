...
{
    /// <summary>
    /// Continues triggering events with a synchronous workflow produced by a factory that takes the yielded triggering events.
    /// </summary>
    /// <param name="createContinuation">A factory that takes two events of types <typeparamref name="TTriggerEvent1"/> and <typeparamref name="TTriggerEvent2"/> and returns a synchronous workflow.</param>
    /// <returns>A new asynchronous <see cref="Workflow{TEvent}"/> that yields all the events yielded by the original, and intercalates the synchronous workflow returned by a new call to the given <paramref name="createContinuation"/> factory after each pair of yielded triggering events.</returns>
    ...
    /// <summary>
    /// Continues triggering events with a synchronous workflow produced by a factory that takes the yielded triggering events and one additional argument.
    /// </summary>
    /// <param name="createContinuation">A factory that takes two events of types <typeparamref name="TTriggerEvent1"/> and <typeparamref name="TTriggerEvent2"/> and one additional argument, and returns a synchronous workflow.</param>
    ...
    /// </summary>
    /// <param name="createContinuation">A factory that takes two events of types <typeparamref name="TTriggerEvent1"/> and <typeparamref name="TTriggerEvent2"/> and two additional arguments, and returns a synchronous workflow.</param>
    ...
    /// </summary>
    /// <param name="createContinuation">A factory that takes two events of types <typeparamref name="TTriggerEvent1"/> and <typeparamref name="TTriggerEvent2"/> and three additional arguments, and returns a synchronous workflow.</param>
    /// <param name="arg1">The first additional argument passed to the given <paramref name="createContinuation"/> factory.</param>
    /// <param name="arg2">The second additional argument passed to the given <paramref name="createContinuation"/> factory.</param>
