...
public partial class Workflow<TEvent>
{
    ...
    public Workflow<TEvent> Then(
        ...
        => WorkflowImpl.ThenFromTask(_workflow, continuation).ToWorkflow();
    ...
    public Workflow<TEvent> Then(
        ...
        => WorkflowImpl.ThenFromTaskFactory(_workflow, createContinuation).ToWorkflow();
    ...
    public Workflow<TEvent> Then<TArg>(
        ...
        => WorkflowImpl.ThenFromTaskFactory(_workflow, createContinuation.BindAll(arg)).ToWorkflow();
    ...
    public Workflow<TEvent> Then<TArg1, TArg2>(
        ...
        => WorkflowImpl.ThenFromTaskFactory(_workflow, createContinuation.BindAll(arg1, arg2)).ToWorkflow();
    ...
    public Workflow<TEvent> Then<TArg1, TArg2, TArg3>(
        ...
        => WorkflowImpl.ThenFromTaskFactory(_workflow, createContinuation.BindAll(arg1, arg2, arg3)).ToWorkflow();
}
