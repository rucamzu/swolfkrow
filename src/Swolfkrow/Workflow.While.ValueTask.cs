...
public partial class Workflow<TEvent>
{
    ...
    public Workflow<TEvent> While<TArg>(
        ...
        => WorkflowImpl.WhileFromValueTaskPredicate(_workflow, predicate.BindLast(arg)).ToWorkflow();
    ...
    public Workflow<TEvent> While<TArg1, TArg2>(
        ...
        => WorkflowImpl.WhileFromValueTaskPredicate(_workflow, predicate.BindLast(arg1, arg2)).ToWorkflow();
    ...
    public Workflow<TEvent> While<TArg1, TArg2, TArg3>(
        ...
        => WorkflowImpl.WhileFromValueTaskPredicate(_workflow, predicate.BindLast(arg1, arg2, arg3)).ToWorkflow();
}