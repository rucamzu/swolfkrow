...
public partial class Trigger<TEvent>
{
    ...
    /// </summary>
    /// <param name="createContinuation">A factory that takes an event of type <typeparamref name="TEvent"/> and returns an asynchronous workflow.</param>
    ...
    public Workflow<TEvent> Then(
        ...
        => WorkflowImpl.ThenFromTriggered0AsyncEnumerableFactory(
    ...
    /// </summary>
    /// <param name="createContinuation">A factory that takes an event of type <typeparamref name="TEvent"/> and one additional argument, and returns an asynchronous workflow.</param>
    ...
    public Workflow<TEvent> Then<TArg>(
        ...
        => WorkflowImpl.ThenFromTriggered0AsyncEnumerableFactory(_workflow, _predicate, createContinuation.BindLast(arg)).ToWorkflow();
    ...
    /// </summary>
    /// <param name="createContinuation">A factory that takes an event of type <typeparamref name="TEvent"/> and two additional arguments, and returns an asynchronous workflow.</param>
    ...
    public Workflow<TEvent> Then<TArg1, TArg2>(
        ...
        => WorkflowImpl.ThenFromTriggered0AsyncEnumerableFactory(_workflow, _predicate, createContinuation.BindLast(arg1, arg2)).ToWorkflow();
    ...
    /// </summary>
    /// <param name="createContinuation">A factory that takes an event of type <typeparamref name="TEvent"/> and three additional arguments, and returns an asynchronous workflow.</param>
    /// <param name="arg1">The first additional argument passed to the given <paramref name="createContinuation"/> factory.</param>
    /// <param name="arg2">The second additional argument passed to the given <paramref name="createContinuation"/> factory.</param>
    ...
    public Workflow<TEvent> Then<TArg1, TArg2, TArg3>(
        ...
        => WorkflowImpl.ThenFromTriggered0AsyncEnumerableFactory(_workflow, _predicate, createContinuation.BindLast(arg1, arg2, arg3)).ToWorkflow();
}
