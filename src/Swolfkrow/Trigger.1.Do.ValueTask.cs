...
public partial class Trigger<TEvent, TTriggerEvent>
{
    ...
    public Workflow<TEvent> Do(
        ...
        => WorkflowImpl.DoFromTriggered1ValueTask(
    ...
    public Workflow<TEvent> Do<TArg>(
        ...
        => WorkflowImpl.DoFromTriggered1ValueTask(_workflow, _predicate, effect.BindLast(arg)).ToWorkflow();
    ...
    public Workflow<TEvent> Do<TArg1, TArg2>(
        ...
        => WorkflowImpl.DoFromTriggered1ValueTask(_workflow, _predicate, effect.BindLast(arg1, arg2)).ToWorkflow();
    ...
    public Workflow<TEvent> Do<TArg1, TArg2, TArg3>(
        ...
        => WorkflowImpl.DoFromTriggered1ValueTask(_workflow, _predicate, effect.BindLast(arg1, arg2, arg3)).ToWorkflow();
}
