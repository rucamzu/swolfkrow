...
public partial class Trigger<TEvent, TTriggerEvent>
{
    ...
    public Workflow<TEvent> Then<TArg>(
        ...
        => WorkflowImpl.ThenFromTriggered1AsyncEnumerableFactory(_workflow, _predicate, createContinuation.BindLast(arg)).ToWorkflow();
    ...
    public Workflow<TEvent> Then<TArg1, TArg2>(
        ...
        => WorkflowImpl.ThenFromTriggered1AsyncEnumerableFactory(_workflow, _predicate, createContinuation.BindLast(arg1, arg2)).ToWorkflow();
    ...
    public Workflow<TEvent> Then<TArg1, TArg2, TArg3>(
        ...
        => WorkflowImpl.ThenFromTriggered1AsyncEnumerableFactory(_workflow, _predicate, createContinuation.BindLast(arg1, arg2, arg3)).ToWorkflow();
}
