...
public partial class Trigger<TEvent, TTriggerEvent>
{
    ...
    /// </summary>
    /// <param name="createContinuation">A factory that takes an event of type <typeparamref name="TTriggerEvent"/> and returns a synchronous workflow.</param>
    ...
    /// </summary>
    /// <param name="createContinuation">A factory that takes an event of type <typeparamref name="TTriggerEvent"/> and one additional argument and returns a synchronous workflow.</param>
    ...
    public Workflow<TEvent> Then<TArg>(
        ...
        => WorkflowImpl.ThenFromTriggered1EnumerableFactory(_workflow, _predicate, createContinuation.BindLast(arg)).ToWorkflow();
    ...
    /// </summary>
    /// <param name="createContinuation">A factory that takes an event of type <typeparamref name="TTriggerEvent"/> and two additional arguments and returns a synchronous workflow.</param>
    ...
    public Workflow<TEvent> Then<TArg1, TArg2>(
        ...
        => WorkflowImpl.ThenFromTriggered1EnumerableFactory(_workflow, _predicate, createContinuation.BindLast(arg1, arg2)).ToWorkflow();
    ...
    /// </summary>
    /// <param name="createContinuation">A factory that takes an event of type <typeparamref name="TTriggerEvent"/> and three additional arguments and returns a synchronous workflow.</param>
    /// <param name="arg1">The first additional argument passed to the given <paramref name="createContinuation"/> factory.</param>
    /// <param name="arg2">The second additional argument passed to the given <paramref name="createContinuation"/> factory.</param>
    ...
    public Workflow<TEvent> Then<TArg1, TArg2, TArg3>(
        ...
        => WorkflowImpl.ThenFromTriggered1EnumerableFactory(_workflow, _predicate, createContinuation.BindLast(arg1, arg2, arg3)).ToWorkflow();
}
