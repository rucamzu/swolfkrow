...
public static partial class Workflow
{
    ...
    /// <typeparam name="TEvent">The (base) type of the event yielded by the asynchronous workflow.</typeparam>
    /// <returns>An asynchronous workflow that calls the given <paramref name="createTask"/> factory with the given <paramref name="arg"/>ument and yields the result of the resulting task as its only event.</returns>
    /// <remarks>
    /// This function serves as entry point to the DSL.
    /// </remarks>
