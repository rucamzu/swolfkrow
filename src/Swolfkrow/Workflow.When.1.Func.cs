...
{
    /// <summary>
    /// Initiates a two-step conditional composition that will be triggered by every event of type <typeparamref name="TTriggerEvent"/> yielded by <see langword="this"/> asynchronous workflow that satisfies a given <paramref name="predicate"/>.
    /// </summary>
    /// <param name="predicate">A predicate that takes an event of type <typeparamref name="TTriggerEvent"/>.</param>
    ...
    /// Initiates a two-step conditional composition that will be triggered by every event of type <typeparamref name="TTriggerEvent"/> yielded by <see langword="this"/> asynchronous workflow that satisfies a given <paramref name="predicate"/>.
    /// </summary>
    /// <param name="predicate">A predicate that takes an event of type <typeparamref name="TTriggerEvent"/> and one additional argument.</param>
    ...
    public Trigger<TEvent, TTriggerEvent> When<TTriggerEvent, TArg>(
        ...
        where TTriggerEvent : TEvent
        => new Trigger<TEvent, TTriggerEvent>(this,
            Predicate1.FromPredicate(predicate.BindLast(arg)));

    /// <summary>
    /// Initiates a two-step conditional composition that will be triggered by every event of type <typeparamref name="TTriggerEvent"/> yielded by <see langword="this"/> asynchronous workflow that satisfies a given <paramref name="predicate"/>.
    /// </summary>
    /// <param name="predicate">A predicate that takes an event of type <typeparamref name="TTriggerEvent"/> and two additional arguments.</param>
    ...
    public Trigger<TEvent, TTriggerEvent> When<TTriggerEvent, TArg1, TArg2>(
        ...
        where TTriggerEvent : TEvent
        => new Trigger<TEvent, TTriggerEvent>(this,
            Predicate1.FromPredicate(predicate.BindLast(arg1, arg2)));

    /// <summary>
    /// Initiates a two-step conditional composition that will be triggered by every event of type <typeparamref name="TTriggerEvent"/> yielded by <see langword="this"/> asynchronous workflow that satisfies a given <paramref name="predicate"/>.
    /// </summary>
    /// <param name="predicate">A predicate that takes an event of type <typeparamref name="TTriggerEvent"/> and three additional arguments.</param>
    /// <param name="arg1">The first additional argument passed to the given <paramref name="predicate"/>.</param>
    /// <param name="arg2">The second additional argument passed to the given <paramref name="predicate"/>.</param>
    ...
    public Trigger<TEvent, TTriggerEvent> When<TTriggerEvent, TArg1, TArg2, TArg3>(
        ...
        where TTriggerEvent : TEvent
        => new Trigger<TEvent, TTriggerEvent>(this,
            Predicate1.FromPredicate(predicate.BindLast(arg1, arg2, arg3)));
}
